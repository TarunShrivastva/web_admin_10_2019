...
<div class="single-blog-post featured-post single-post">
    ...
    <table class="table-n" align="center">
            ...
            <table class="table-n" align="center">
                    <tbody><tr>
                        <td align="center"><h4>Best Mobile Phones Under 7000 in India</h4></td>
                    </tr>
                    <tr>
                        <td>
                            <table cellspacing="0" cellpadding="0">
...
<div class="row">
    ...
    <div class="col-12">
        <div class="single-blog-post style-3 mb-80">
            <div class="post-thumb">
                <a href="#"><amp-img src="{{ URL::to('images/12.jpg') }}"  alt="singleblog" width="1000" height="876" layout="responsive"></amp-img></a>
            </div>
     <div class="post-data">
                ...
                <div class="post-meta d-flex align-items-center">
                    <a href="#" class="post-like"><amp-img src="{{ URL::to('images/like.png') }}"  alt="like" width="17" height="17" layout="responsive" sizes="(min-width: 569px) 17px, 17px"></amp-img> <span>392</span></a>
                    <a href="#" class="post-comment"><amp-img src="{{ URL::to('images/chat.png') }}"  alt="search" width="17" height="17" layout="responsive" sizes="(min-width: 569px) 17px, 17px"></amp-img> <span>10</span></a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-12">
        <div class="single-blog-post style-3 mb-80">
            <div class="post-thumb">
                <a href="#"><amp-img src="{{ URL::to('images/13.jpg') }}"  alt="singleblog" width="1000" height="876" layout="responsive"></amp-img></a>
            </div>
            <div class="post-data">
                <a href="#" class="post-catagory">Finance</a>
                <a href="#" class="post-title">
        ...
        <li class="single_comment_area">
            ...
            <div class="comment-content d-flex">
                ...
                <div class="comment-meta">
                    ...
                    <p>Donec turpis erat, 
scelerisque id euismod sit amet, fermentum vel dolor. Nulla facilisi. 
Sed pellen tesque lectus et accu msan aliquam. Fusce lobortis cursus 
quam, id mattis sapien.</p>
                </div>
            </div>
        </li>
            <!-- Single Comment Area -->
        <li class="single_comment_area">
            ...
            <div class="comment-content d-flex">
                <!-- Comment Author -->
                <div class="comment-author">
                    <amp-img src="{{ URL::to('images/32.jpg') }}" alt="comment-author" width="100" height="100" layout="responsive" sizes="(min-width: 569px) 50px, 50px"></amp-img>
                </div>
                <!-- Comment Meta -->
                <div class="comment-meta">
                    <a href="#" class="post-author">Christian Williams</a>
